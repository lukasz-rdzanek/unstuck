...
- [x] 4.1 `npm run lint` exits 0 — ad4b29f
- [x] 4.2 `npm run build` exits 0 — ad4b29f
- [x] 4.3 `npx astro check` exits 0 — ad4b29f
- [x] 4.4 `npx supabase db reset` applies cleanly with updated seed — ad4b29f
