...
| 2 | Grading & SRS integration | Quiz scores match an independent oracle; SRS scheduling + message-embedding immutability hold | R3, R5, R2 (attempts/SRS own-only) | integration (local Supabase, RPC) | planned | context/changes/testing-grading-srs-integration/ |
